// given as test for course exercise...
// from: https://pastebin.com/RitufP4K and improved
...
public class TestLista {
    ...
    private static void checkMiaStringa(Lista<Character> stringa){
        System.out.println(stringa.size() == 0 ? "OK" : "ERRORE");

        stringa.add('a');
        System.out.println(stringa.size() == 1 ? "OK" : "ERRORE");

        System.out.println(stringa.get(0) == 'a' ? "OK" : "ERRORE");
    ...
    private static void checkListaInteri(Lista<Integer> lista){
        System.out.println(lista.size() == 0 ? "OK" : "ERRORE");

        lista.add(5);
        System.out.println(lista.size() == 1 ? "OK" : "ERRORE");

        System.out.println(lista.get(0) == 5 ? "OK" : "ERRORE");
